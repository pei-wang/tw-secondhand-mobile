...
class OthersScreen extends React.Component<DispatchProp<{}>, {}> {
  render() {
    const textfieldStyle = {fontSize: 13, color: 'lightgray', height: 40, width: 250, marginBottom: 20, borderColor: '#A4A4A4', borderBottomWidth: 1};
    const uploadDefault = require('../resources/uploading-archive.png');
    return (
      <View style={styles.container}>
        <View style={styles.uploader}>
          <Text style={{color: 'lightgray', fontSize: 20, marginBottom: 10}}>点击上传图片</Text>
        ...
        style={{fontSize: 13, color: 'lightgray', height: 100, width: 250, marginBottom: 20, borderColor: '#A4A4A4', borderWidth: 1}}/>
